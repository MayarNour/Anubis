...
class Widget(QWidget):
    ...
    def initUI(self):
        ...
        parametersmenu = QLabel(self)
        parametersmenu.setText("For Run Function feature only!!\nParameters are separated by ';' ")
        V_splitter.addWidget(parametersmenu)
        global parameterstext
        parameterstext = QLineEdit(self)
        V_splitter.addWidget(parameterstext)
...
class UI(QMainWindow):
    ...
    def intUI(self):
        ...
        ExecFn = menu.addMenu('Execute Function')
...
#        Port.addAction(Port_Action)
        ...
        # Making and adding execute function Actions
        ExecFnAction = QAction("ExecFn", self)
        ExecFnAction.triggered.connect(self.ExecFn)
        ExecFn.addAction(ExecFnAction)
